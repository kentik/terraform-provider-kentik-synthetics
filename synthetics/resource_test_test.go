	...
	resource.UnitTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{{
			...
			Check: resource.ComposeTestCheckFunc(
				...
				resource.TestCheckResourceAttr(testResource, "settings.0.monitoring_settings.0.notification_channels.0", "nc-one"),
				resource.TestCheckResourceAttr(testResource, "settings.0.monitoring_settings.0.notification_channels.1", "nc-two"),
			...
			Check: resource.ComposeTestCheckFunc(
				...
				resource.TestCheckResourceAttr(testResource, "settings.0.monitoring_settings.0.notification_channels.0", "nc-one"),
				resource.TestCheckResourceAttr(testResource, "settings.0.monitoring_settings.0.notification_channels.1", "nc-two"),
				resource.TestCheckResourceAttr(testResource, "settings.0.monitoring_settings.0.notification_channels.2", "nc-three"),
